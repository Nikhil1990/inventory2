...
<div class="col-md-12">
	<div class="box box-primary">
		<div class="box-header">
			...
			<center><h2 class="box-title">Edit Product</h2></center>
		...
		<form method="POST" id="product_form">
				...
				<div class="row">
                    <div class="form-group col-md-4">
                      ...
                      <input name="p_code" placeholder="Enter Product Code" class="form-control" value="<?php echo $product->p_code; ?>">
                ...
                <div class="row">
                    <div class="form-group col-md-4">
                      ...
                      <input name="p_name" placeholder="Enter Product Name" class="form-control" value="<?php echo $product->p_name; ?>">
				...
				<div class="row">
                    <div class="form-group col-md-4">
                      ...
                      <input name="p_price" placeholder="Enter Product Price" class="form-control" value="<?php echo $product->p_price; ?>">
                      ...
                      <select name="p_b_id" class="form-control">
							...
							<?php 
								...
								foreach($brand_details as $brand)
								{
									...
									if($brand->b_id==$product->p_b_id)
									{
									
							?>
									
										<option value="<?php echo $brand->b_id; ?>" selected><?php echo $brand->b_name; ?></option>
                      ...
                      <select name="p_c_id" class="form-control">
							...
							<?php 
								...
								foreach($category_details as $category)
								{
									...
									if($category->c_id==$product->p_c_id)
									{
									
									
							?>
									
										<option value="<?php echo $category->c_id; ?>" selected><?php echo $category->c_name; ?></option>
				...
				<div class="row">
                    <div class="form-group col-md-4">
                      ...
                      <select name="p_pt_id" class="form-control">
							...
							<?php 
								...
								{
									if($product_type->pt_id == $product->p_pt_id)
									{
							?>
									
										<option value="<?php echo $product_type->pt_id; ?>" selected><?php echo $product_type->pt_type; ?></option>
				 ...
				 <div class="row">
                    <div class="form-group col-md-4">
                      ...
                      <input name="p_min_stock_level" placeholder="Enter Minimum Stock Level" class="form-control" value="<?php echo $product->p_min_stock_level; ?>">
