...
<div class="col-md-12">
	<div class="box box-primary">
		<div class="box-header">
			...
			<center><h2 class="box-title">Edit Brand</h2></center>
		...
		<form method="POST" id="brand_form">
                ...
                <div class="row">
                    <div class="form-group col-md-4">
                      ...
                      <input name="b_name" placeholder="Enter Brand Name" class="form-control" value="<?php echo $brand->b_name; ?>">
					  <div id='brand_form_b_name_errorloc' style="color:red;"></div>
                    </div>
				</div>
				
				<div class="box-footer">
                    <button class="btn btn-primary" type="submit" name="edit_brand" >Save Changes</button>
                 </div>
