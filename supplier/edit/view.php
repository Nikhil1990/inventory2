...
<div class="col-md-12">
	<div class="box box-primary">
		<div class="box-header">
			...
			<center><h2 class="box-title">Edit Supplier</h2></center>
		...
		<form method="POST" id="supplier_form">
                ...
                <div class="row">
                    <div class="form-group col-md-4">
                      ...
                      <input name="sup_name" placeholder="Enter Supplier Name" class="form-control" value="<?php echo $supplier->sup_name; ?>">
				...
				<div class="row">
                    <div class="form-group col-md-4">
                      <label>Address</label>
                      <textarea name="sup_address" placeholder="Enter Supplier Name" class="form-control"><?php echo $supplier->sup_address; ?></textarea>
				 ...
				 <div class="row">
                    <div class="form-group col-md-4">
                      ...
                      <input name="sup_email" placeholder="Enter Supplier Email" class="form-control" value="<?php echo $supplier->sup_email; ?>">
				 ...
				 <div class="row">
                    <div class="form-group col-md-4">
                      ...
                      <input name="sup_phoneno" placeholder="Enter Supplier Phone Number" class="form-control" value="<?php echo $supplier->sup_phoneno; ?>">
				...
				<div class="row">
                    <div class="form-group col-md-4">
                      ...
                      <input name="sup_c_person" placeholder="Enter Contact Person Name" class="form-control" value="<?php echo $supplier->sup_c_person; ?>">
				...
				<div class="box-footer">
                    <button class="btn btn-primary" type="submit" name="edit_supplier" >Save Changes</button>
                 </div>
